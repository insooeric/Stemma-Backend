...
namespace Stemma.Models.Github
{
    public class GithubProjectModel
    {
        ...
        public GithubProjectUserModel Owner { get; set; } = new GithubProjectUserModel();
        ...
        public GithubProjectLicense License { get; set; } = new GithubProjectLicense();
    ...
    public class GithubProjectUserModel
    {
